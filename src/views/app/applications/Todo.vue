<template>
  <div class="disable-text-selection">
    ...
    <todo-application-menu v-if="isLoad" :items="items" :labels="labels"></todo-application-menu>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapGetters(["isLoad", "items", "todoError", "labels"])
  },
  methods: {
    ...mapActions(["getTodoItems", "getLabels"]),
    isSelectedAll() {
