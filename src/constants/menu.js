...
const isSuperAdmin = localStorage.getItem('gce_is_sg');
...
{
  id: "file_recieved",
  icon: "iconsminds-arrow-back-3",
  label: "menu.file_recieved",
  show: true,
  to: `${adminRoot}/files/recieved`,
},
{
  id: "file_sent",
  icon: "iconsminds-arrow-forward-2",
  label: "menu.file_sent",
  show: true,
  to: `${adminRoot}/files/sent`,
},
{
  id: "file_interne",
  icon: "iconsminds-arrow-into",
  label: "menu.file_interne",
  show: true,
  to: `${adminRoot}/files/interne`,
},
{
  id: "file_traited",
  icon: "simple-icon-docs",
  label: "menu.file_traited",
  show: true,
  to: `${adminRoot}/files/traited`,
},
{
  id: "file_archived",
  icon: "iconsminds-check",
  label: "menu.file_archived",
  show: true,
  to: `${adminRoot}/files/archived`,
},
...

{
  ...
  label: "menu.entity-interne",
  show: true,
  to: `${adminRoot}/entity-interne`,
  subs: []
},
